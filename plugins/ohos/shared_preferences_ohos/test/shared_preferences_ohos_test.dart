...
void main() {
  ...
  test('registerWith', () {
    ...
    expect(
        SharedPreferencesStorePlatform.instance, isA<SharedPreferencesOhos>());
  });
  ...
  test('setValue', () async {
    ...
    expect(api.items['flutter.Double'], isA<String>());
    expect((await plugin.getAll())['flutter.Double'], 1.5);
